        	...
        	for(int i=1;i<=346;i++)
        	{
        		...
        		for(int j=0;j<link.size();j++)
        		{
        		  try
        		  {
        		   ...
        		   // 파일에 저장
        		   FileWriter fw = new FileWriter("c:\\javadv\\food.txt", true);
        		   /*
        		    *  w, r, a
        		    *  - write => create
        		    *  - read
        		    ...
        		    * 
        		    */
        		   String data = m+"|"+vo.getName()+"|"+vo.getType()+"|"+vo.getPhone()+"|"+vo.getAddress()+"|"+vo.getScore()+"|"
        		    +vo.getParking()+"|"+vo.getPoster()+"|"+vo.getTime()+"|"
        		    +vo.getContent()+"|"+vo.getTheme()+"|"+vo.getPrice()+"\r\n";
